...
namespace CoPilot.Speedway.Controller
{
    ...
    {
        private const double MIN_ACCURACY = 20;
        ...
        public bool IsAccured
        {
            get
            {
                return this.IsGpsEnabled && this.gpsSenzor.Position.Location.HorizontalAccuracy <= MIN_ACCURACY;
            }
        }
        ...
        /// Center
        /// </summary>
        public GeoCoordinate center = GeoCoordinate.Unknown;
